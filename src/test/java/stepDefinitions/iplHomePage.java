...
public iplHomePage(TestContextSetup globalVariable) 
{
	...
	public void user_searched_with_the_ipl_in_the_search_box() throws InterruptedException {
		...
		//iplhomePage iplhomepage = new iplhomePage(globalVariable.driver);
		//pageObjectManager -= new PageObjectManager(globalVariable.driver);
		IplHomePage iplhomepage = globalVariable.pabeObjectManager.getIplHomePage();
		iplhomepage.searchUrl();
